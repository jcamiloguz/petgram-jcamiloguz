...
define("./service-worker.js",['./workbox-99319794'], function (workbox) { 'use strict';
  ...
  */
  ...
  workbox.precacheAndRoute([{
    "url": "/0.app.bundle.js",
    "revision": "a2613f446ca62803a28b4fd5b760c64c"
  }, {
    "url": "/1.app.bundle.js",
    "revision": "3c1fa6a29f2d6d7dc7012bc586a9b9fb"
  }, {
    "url": "/2.app.bundle.js",
    "revision": "f03af48f4a8ca542f5be85b348bd75d1"
  }, {
    "url": "/3.app.bundle.js",
    "revision": "314ef898fec36367f71ede62881baf7c"
  }, {
    ...
    "url": "/index.html",
    "revision": "05058d8ce857ac2324bdaf0d79809724"
  }, {
    "url": "/manifest.3b119629a630f54edfdbafc8e9f643c4.json",
    "revision": "3b119629a630f54edfdbafc8e9f643c4"
  }], {});
  workbox.registerRoute(/https:\/\/(res.cloudinary.com|images.unsplash.com)/, new workbox.CacheFirst({
    "cacheName": "images",
    plugins: []
  }), 'GET');
  workbox.registerRoute(/https:\/\/petgram-server-jcamiloguz.jcamiloguz.vercel.app/, new workbox.NetworkFirst({
    "cacheName": "api",
    plugins: []
  }), 'GET');
